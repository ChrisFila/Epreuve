 ...
 */
final class Version20210405133228 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE compte_rendu (id INT AUTO_INCREMENT NOT NULL, praticien_id INT NOT NULL, date_visite DATETIME NOT NULL, motif VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, INDEX IDX_D39E69D22391866B (praticien_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE presentation (id INT AUTO_INCREMENT NOT NULL, compte_rendu_id INT NOT NULL, INDEX IDX_9B66E8934BC44A10 (compte_rendu_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
